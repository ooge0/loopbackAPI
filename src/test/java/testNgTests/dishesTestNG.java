//package testNgTests;//package restassured.api.steps;
//
...
//        request = given();
//        response = request.when().get("/DishesSteps");
//    }
//
//    @Test
...
//        given()
//                .when()
//                .delete("/DishesSteps/" + deleted_dish_ID)
//                /*
//                .then()
//                .statusCode(200)
//                .and()
...
//        given()
//                .when()
//                .get("/DishesSteps/5b1fb4cc4e749dec8817db5c")
//                .then()
//                .statusCode(200);
//    }
//
...
//                .when()
//                .contentType(ContentType.JSON)
//                .get("/DishesSteps/5b1e99d42548d06378fe20a6")
//                .then()
//                .statusCode(200);
//    }
//
...
//        Response response = request.post("/DishesSteps");
//
